...
def train_net(net,
    ...
    dir_img = '/home/leroux/pfe/datapfeval/images/'
    dir_mask = '/home/leroux/pfe/datapfeval/masks/'
    dir_checkpoint = '/home/leroux/pfe/unetedit/checkpoints/'
...
##
    parser.add_option('-a', '--class', dest='class_mark',
                      default=[0,7,2,3], help='intensity in mask image')
##
